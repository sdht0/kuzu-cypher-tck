...
Feature: Match6 - Match named paths scenarios
  ...
  @modified @outputModified @fails @extraOutputUndirected @testbug
  ...
  @modified @outputModified @fails @parserErrorDoubleArrow
  ...
  @modified @outputModified @fails @extraOutputUndirected @keywordClash
  ...
  @modified @outputModified @fails @bugUnexpectedOutput @kuzubug
